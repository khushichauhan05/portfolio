...
export default function Home() {
  ...
  const handleOpenGitHub = () => {
    window.open("https://github.com/khushichauhan05", "_blank", "noreferrer");
  };
  ...
  const handleOpenHobbies = () => {
    const newTab = {
      ...
      title: "My Hobbies",
      message:
        "When I'm not coding, I love travelling and exploring new places, and I'm a big fan of movies and shows - always adding to my never-ending watchlist!",
    };
    store.dispatch(addTab(newTab));
  };
  ...
  return (
    <>
      <Head>
        <title>Khushi Chauhan&apos;s Personal Website - Home Page</title>
        <meta
          name="description"
          content="Khushi Chauhan - Associate Software Engineer @ ServiceNow. Portfolio built as a Windows XP desktop."
        />
